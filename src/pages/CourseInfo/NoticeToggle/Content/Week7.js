...
import Model from "../../NoticeToggle/Content/ThreeDModels/Model"
import "./Weekcss.css"
const Week7 = () => {
...
,
  ...
  return (
    ...
    <Model src="https://sketchfab.com/models/cf08ddb01ceb47edbd9cefa786a03f2c/embed" title = "X-ray Airport"> </Model>
    {data.map((step, index) => (
